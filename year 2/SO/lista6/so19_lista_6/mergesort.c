...
// rodzic wysyła dziecku nelem liczb, które otrzymał od swojego rodzica
...
// do rodzica (parent_fd) trafiają wszystkie liczby z lewego i prawego procesu posortowane
